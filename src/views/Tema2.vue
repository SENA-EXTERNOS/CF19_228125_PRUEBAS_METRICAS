      ...
      AcordionA(tipo="b" clase-tarjeta="tarjeta tarjeta--blanca")(data-aos="fade-left") 
        #t_2_1.row(titulo="Basadas en la especificación")
          .col-md-12.mb-4.mb-md-0
            ...
            p.mb-2 Esta técnica es fundamental durante las etapas del ciclo de vida de las pruebas de #[i software], como las pruebas de regresión, la aceptación, la unidad, el sistema, la integración y el desarrollo de #[i software].
            .row.justify-content-center.align-items-center.mb-2
              .col-lg-7
                .crd-paleBlue.mb-3
                  p.p-3 Las técnicas de prueba de caja negra son beneficiosas para los usuarios finales que desean realizar la verificación del #[i software]. Las técnicas más destacadas dentro de estas son:
                ul.lista-ul--color
                  li 
                    i.fas.fa-play
        ...
        #t_2_5.row(titulo="Basadas en la naturaleza de la aplicación")
          .col-md-7.mb-4.mb-md-0
            ...
            ul.lista-ul--color
              ...
              li 
                i.fas.fa-play
                p.mb-0 Sistemas de seguridad críticos: esto es, sistemas #[i software] cuyo fallo o mal funcionamiento puede perjudicar gravemente la vida, el medio ambiente o algún tipo de equipamiento.
        ...
        #t_2_6.row(titulo="Basadas en la finalidad de las mismas")
          .col-md-7.mb-4.mb-md-0
            ...
            ul.lista-ul--color
              li 
                i.fas.fa-play
                p.mb-0 Instalación: comprueban que el #[i software] puede ser instalado en el entorno objetivo.
              li 
                i.fas.fa-play
                p.mb-0 Pruebas de compatibilidad: comprueban que el #[i software] sigue funcionando con otras aplicaciones, sistemas operativos o entornos diferente al original.
              li 
                i.fas.fa-play
                p.mb-0 Alpha o Beta #[i Tester]: el objetivo es que un grupo representativo de usuarios utilice el sistema antes de realizar su paso a la etapa en producción.
              li 
                i.fas.fa-play
              ...
              li 
                i.fas.fa-play
                p.mb-0 Usabilidad: evalúan cómo de fácil es para los usuarios finales usar y aprender a usar el #[i software].
              li 
                i.fas.fa-play
                p.mb-0 Accesibilidad: comprueban que el #[i software] es accesible, por ejemplo, para personas con visión reducida, audición reducida o movilidad reducida, entre otros aspectos.
              li 
                i.fas.fa-play
              ...
              li 
                i.fas.fa-play
                p.mb-0 Regresión: comprueban que las modificaciones realizadas en el sistema no causen comportamientos indeseados en otras partes del #[i software].
